...
const NotificationsPage: React.FC = () => {
  ...
  const handleNotificationClick = (notif: any) => {
    ...
    if (notif.link) {
      ...
      if (notif.type === 'order-placed' || notif.type === 'order-shipped' || notif.type === 'order-delivered') {
        user?.role === 'seller' ? navigate('/seller/orders') : navigate('/orders');
      } else if (notif.type === 'product-approved' || notif.type === 'product-rejected') {
        user?.role === 'seller' ? navigate('/seller/products') : navigate('/products');
      } else if (notif.type === 'promotion-approved' || notif.type === 'promotion-rejected') {
        user?.role === 'seller' ? navigate('/seller/promotions') : navigate('/');
      }
    }
  };
